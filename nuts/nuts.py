...
def nuts6(f, M, Madapt, theta0, delta=0.6, progress=False, epsilon=None):
    """
    ...
    epsilon: float
        initial step size; will guess at a reasonable value if not given 
    ...
    lnprob: ndarray[float, ndim=1]
        M vector of logp values
    
    epsilon: final adapted epsilon
    """
    ...
    epsilonbar = epsilon if Madapt == 0 else 1
    Hbar = 0
